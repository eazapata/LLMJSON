 ...
 function realitzarcerca() {
     ...
     //Comprovarem el filtre de llists. Si concorden els llits de l'habitació cercarem pels altres filtres.
             if ((objHab.camas.indiv == numIndividual) && (objHab.camas.doble == numDoble)) {
                var prueba = JSON.stringify(objHab.precios);
                alert(prueba);
 ...
 function pintarInformacioHotelHabPreu(objInformacioElement) {
     ...
     */
     ...
     StrHtml += "<div>Preu Total " + objInformacioElement.preu.valorTotal + " </div>";
     StrHtml += "</div>";
     ...
     //StrHtml += "<input type=\"number\" id=\"" + objInformacioElement.hotel.hotelid + "_" + objInformacioElement.hab.habitacion + "_" + objInformacioElement.preu.tempAlta + "_" + objInformacioElement.preu.prov + "\" />";
    // StrHtml += "<button type=\"button\" onclick=\"seleccionarHabitacio(" + objInformacioElement.hotel.id + "," + objInformacioElement.hab.id + "," + objInformacioElement.preu.tempAlta + ",'" + objInformacioElement.preu.prov + "'," + objInformacioElement.preu.valorTotal + ")\" >Seleccionar. </button>";
     StrHtml += "</div>";
     StrHtml += "</div>";
     StrHtml += "";
